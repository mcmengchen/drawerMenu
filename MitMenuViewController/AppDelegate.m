...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MitMenuViewController * vi = [[MitMenuViewController alloc] initWithMenuWidth:150];
    vi.type = MitMenuTypeNormal;
    MitMainViewController * mainVi = [MitMainViewController new];
    MitLeftViewController * leftVi = [MitLeftViewController new];
    vi.mainViewController = mainVi;
    vi.leftViewController = leftVi;
